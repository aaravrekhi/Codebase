...
int main(int argc, char **argv)
{
    ...
    if (UnitNumber == 4)
    {
	// check insertion and deletion of worst case
	const int ins[] = {6, 7, 8, 9, 0, 1, 2, 3};
	const int del[] = {2, 0, 3, 6}; 
        unitDriver(ins, sizeof ins / sizeof(int),
		   del, sizeof del / sizeof(int));
    }
    if (UnitNumber == 5)
    {
	// check insertion and deletion of the extreme values
	const int ins[] = {0, 63476, -83783, -84370529, 39473};
	const int del[] = {63476, -83783, 0, 39473, -84370529};
        unitDriver(ins, sizeof ins / sizeof(int),
		   del, sizeof del / sizeof(int));
    }
    if (UnitNumber == 6)
    {
	// check the repeated inserions and deletions
	const int ins[] = {15, 5, 30, 37, 7, 0, 8, 0, 47, 20, 21, 20, 30};
	const int del[] = {15, 0, 7, 0, 47, 20, 30, 20, 15, 0, 8}; 
        unitDriver(ins, sizeof ins / sizeof(int),
		   del, sizeof del / sizeof(int));
    }
    if (UnitNumber == 7)
    {
	// check the root deletions
	const int ins[] = {15, 2, 13, 7, 19, 21, 0};
	const int del[] = {15, 7, 19, 11, 12, 3, 9}; 
        unitDriver(ins, sizeof ins / sizeof(int),
		   del, sizeof del / sizeof(int));
    }
    if (UnitNumber == 8)
    {
	// Remove the leaves
	const int ins[] = {15, 0, 20, 0, 12, 8, 23};
	const int del[] = {8, 2, 18, 13, 10, 10, 15}; 
        unitDriver(ins, sizeof ins / sizeof(int),
		   del, sizeof del / sizeof(int));
    }
